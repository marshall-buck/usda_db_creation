...
/// Every nutrient id the source database contains, all 149 of them.
///
/// Informational, and not read by the pipeline. This is the inventory of what
/// `original_usda.json` offers, generated by `DBParser.findAllNutrientIds`, and
/// it is kept so the curated list can be checked against a newer USDA download.
///
/// The list that decides what gets written is `Nutrient.keepTheseNutrients`: 93
/// ids, a strict subset of this one.
